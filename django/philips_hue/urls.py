...
urlpatterns = [
    ...
    path('lights/<identifier>',
         views.get_light_detail, name='light_detail'),
    ...
    path('controls/<endpoint>/<identifier>',
         views.control_light_or_grouped_light, name='control_light'),
]
